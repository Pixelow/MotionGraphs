...
@implementation APLSegmentedControl
...
- (void)setDelegate:(id<APLSegmentedControlDelegate>)delegate
{
    _delegate = delegate;
...
#pragma mark - APLSegmentedControl Methods
